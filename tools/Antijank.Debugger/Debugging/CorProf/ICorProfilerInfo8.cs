...
namespace Antijank.Debugging {
  ...
  public interface ICorProfilerInfo8 : ICorProfilerInfo7 {
    ...
    */
    ...
    [MethodImpl(MethodImplOptions.InternalCall)]
    void GetDynamicFunctionInfo(UIntPtr functionId, out UIntPtr moduleId, [Out] IntPtr ppvSig, out uint pbSig,
      [In] uint cchName, out uint pcchName, out ushort wszName);
