...
namespace Antijank.Debugging {
  ...
  public interface ICorProfilerInfo4 : ICorProfilerInfo3 {
    ...
    */
    ...
    [MethodImpl(MethodImplOptions.InternalCall)]
    void RequestRevert([In] uint cFunctions, ref UIntPtr moduleIds, [In] ref int methodIds,
      [MarshalAs(UnmanagedType.Error)] out int status);

    [MethodImpl(MethodImplOptions.InternalCall)]
    void GetCodeInfo3(UIntPtr functionId, UIntPtr rejitId, [In] uint cCodeInfos, out uint pcCodeInfos,
      [MarshalAs(UnmanagedType.Interface)] [Out]
      ICorProfilerInfo4 codeInfos);

    [MethodImpl(MethodImplOptions.InternalCall)]
    void GetFunctionFromIP2([In] ref byte ip, out UIntPtr pFunctionId, out UIntPtr pReJitId);

    [MethodImpl(MethodImplOptions.InternalCall)]
    void GetReJITIDs(UIntPtr functionId, [In] uint cReJitIds, out uint pcReJitIds,
      [MarshalAs(UnmanagedType.Interface)] [Out]
      ICorProfilerInfo4 reJitIds);

    [MethodImpl(MethodImplOptions.InternalCall)]
    void GetILToNativeMapping2(UIntPtr functionId, UIntPtr rejitId, [In] uint cMap, out uint pcMap,
      [MarshalAs(UnmanagedType.Interface)] [Out]
      ICorProfilerInfo4 map);
