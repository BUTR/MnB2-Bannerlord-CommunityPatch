...
namespace Antijank.Debugging {
  ...
  public interface ICorProfilerInfo9 : ICorProfilerInfo8 {
    ...
    [MethodImpl(MethodImplOptions.InternalCall)]
    void EnumNgenModuleMethodsInliningThisMethod(UIntPtr inlinersModuleId, UIntPtr inlineeModuleId, [In] int inlineeMethodId, out int incompleteData, [MarshalAs(UnmanagedType.Interface)] out ICorProfilerMethodEnum ppEnum);
    [MethodImpl(MethodImplOptions.InternalCall)]
    void ApplyMetaData(UIntPtr moduleId);
    [MethodImpl(MethodImplOptions.InternalCall)]
    void GetInMemorySymbolsLength(UIntPtr moduleId, out uint pCountSymbolBytes);
    [MethodImpl(MethodImplOptions.InternalCall)]
    void ReadInMemorySymbols(UIntPtr moduleId, [In] uint symbolsReadOffset, out byte pSymbolBytes, [In] uint countSymbolBytes, out uint pCountSymbolBytesRead);
    [MethodImpl(MethodImplOptions.InternalCall)]
    void IsFunctionDynamic(UIntPtr functionId, out int isDynamic);
    [MethodImpl(MethodImplOptions.InternalCall)]
    void GetFunctionFromIP3([In] ref byte ip, out UIntPtr functionId, out UIntPtr pReJitId);
    [MethodImpl(MethodImplOptions.InternalCall)]
    void GetDynamicFunctionInfo(UIntPtr functionId, out UIntPtr moduleId, [Out] IntPtr ppvSig, out uint pbSig, [In] uint cchName, out uint pcchName, out ushort wszName);
    */
    [MethodImpl(MethodImplOptions.InternalCall)]
    void GetNativeCodeStartAddresses(UIntPtr functionId, UIntPtr rejitId, uint cCodeStartAddresses,
      ref uint pcCodeStartAddresses, ref UIntPtr codeStartAddresses);

    [MethodImpl(MethodImplOptions.InternalCall)]
    void GetILToNativeMapping3(UIntPtr pNativeCodeStartAddress, uint cMap, ref uint pcMap,
      ref COR_DEBUG_IL_TO_NATIVE_MAP map);

    [MethodImpl(MethodImplOptions.InternalCall)]
    void GetCodeInfo4(UIntPtr pNativeCodeStartAddress, uint cCodeInfos, ref uint pcCodeInfos,
      ref COR_PRF_CODE_INFO codeInfos);
