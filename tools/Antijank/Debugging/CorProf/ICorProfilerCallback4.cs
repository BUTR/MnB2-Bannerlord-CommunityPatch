...
namespace Antijank.Debugging {
  ...
  public interface ICorProfilerCallback4 : ICorProfilerCallback3 {
    ...
    */
    ...
    [MethodImpl(MethodImplOptions.InternalCall)]
    void GetReJITParameters(UIntPtr moduleId, [In] int methodId, [MarshalAs(UnmanagedType.Interface)] [In]
      ICorProfilerFunctionControl pFunctionControl);

    [MethodImpl(MethodImplOptions.InternalCall)]
    void ReJITCompilationFinished(UIntPtr functionId, UIntPtr rejitId,
      [MarshalAs(UnmanagedType.Error)] [In] int hrStatus, [In] int fIsSafeToBlock);

    [MethodImpl(MethodImplOptions.InternalCall)]
    void ReJITError(UIntPtr moduleId, [In] int methodId, UIntPtr functionId,
      [MarshalAs(UnmanagedType.Error)] [In] int hrStatus);

    [MethodImpl(MethodImplOptions.InternalCall)]
    void MovedReferences2([In] uint cMovedObjectIDRanges, ref UIntPtr oldObjectIDRangeStart,
      ref UIntPtr newObjectIDRangeStart, ref UIntPtr cObjectIDRangeLength);

    [MethodImpl(MethodImplOptions.InternalCall)]
    void SurvivingReferences2([In] uint cSurvivingObjectIDRanges, ref UIntPtr objectIDRangeStart,
