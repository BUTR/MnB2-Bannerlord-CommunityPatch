...
namespace Antijank.Debugging {
  ...
  public interface ICorProfilerCallback9 : ICorProfilerCallback8 {
    ...
    [MethodImpl(MethodImplOptions.InternalCall)]
    void DynamicMethodJITCompilationStarted(UIntPtr functionId, [In] int fIsSafeToBlock, [In] ref byte pILHeader, [In] uint cbILHeader);
    [MethodImpl(MethodImplOptions.InternalCall)]
    void DynamicMethodJITCompilationFinished(UIntPtr functionId, [MarshalAs(UnmanagedType.Error)] [In] int hrStatus, [In] int fIsSafeToBlock);
    */
    [MethodImpl(MethodImplOptions.InternalCall)]
    void DynamicMethodUnloaded(UIntPtr functionId);
