...
namespace Antijank.Debugging {
  ...
  public interface ICorProfilerInfo6 : ICorProfilerInfo5 {
    ...
    */
    [MethodImpl(MethodImplOptions.InternalCall)]
    void EnumNgenModuleMethodsInliningThisMethod(UIntPtr inlinersModuleId, UIntPtr inlineeModuleId,
      [In] int inlineeMethodId, out int incompleteData,
      [MarshalAs(UnmanagedType.Interface)] out ICorProfilerMethodEnum ppEnum);
