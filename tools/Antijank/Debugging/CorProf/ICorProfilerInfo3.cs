...
namespace Antijank.Debugging {
  ...
  public interface ICorProfilerInfo3 : ICorProfilerInfo2 {
    ...
    */
    ...
    [MethodImpl(MethodImplOptions.InternalCall)]
    void SetFunctionIDMapper2([MarshalAs(UnmanagedType.Interface)] [In]
      ICorProfilerInfo3 pFunc, [In] IntPtr clientData);
    ...
    [MethodImpl(MethodImplOptions.InternalCall)]
    void SetEnterLeaveFunctionHooks3([MarshalAs(UnmanagedType.Interface)] [In]
      ICorProfilerInfo3 pFuncEnter3, [MarshalAs(UnmanagedType.Interface)] [In]
      ICorProfilerInfo3 pFuncLeave3, [MarshalAs(UnmanagedType.Interface)] [In]
      ICorProfilerInfo3 pFuncTailcall3);
    ...
    [MethodImpl(MethodImplOptions.InternalCall)]
    void SetEnterLeaveFunctionHooks3WithInfo([MarshalAs(UnmanagedType.Interface)] [In]
      ICorProfilerInfo3 pFuncEnter3WithInfo, [MarshalAs(UnmanagedType.Interface)] [In]
      ICorProfilerInfo3 pFuncLeave3WithInfo, [MarshalAs(UnmanagedType.Interface)] [In]
      ICorProfilerInfo3 pFuncTailcall3WithInfo);
    ...
    void GetRuntimeInformation(out ushort pClrInstanceId, out COR_PRF_RUNTIME_TYPE pRuntimeType,
      ...
      [In] uint cchVersionString, out uint pcchVersionString, out ushort szVersionString);
    ...
    void GetModuleInfo2(UIntPtr moduleId, [Out] IntPtr ppBaseLoadAddress, [In] uint cchName, out uint pcchName,
      out ushort szName, out UIntPtr pAssemblyId, out uint pdwModuleFlags);
