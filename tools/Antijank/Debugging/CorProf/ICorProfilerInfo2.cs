...
namespace Antijank.Debugging {
  ...
  public interface ICorProfilerInfo2 : ICorProfilerInfo {
    ...
    */
    [MethodImpl(MethodImplOptions.InternalCall)]
    void StackSnapshotCallback(UIntPtr funcID, UIntPtr ip, UIntPtr frameInfo, uint contextSize, ref byte context,
      IntPtr clientData);

    [MethodImpl(MethodImplOptions.InternalCall)]
    void DoStackSnapshot(UIntPtr thread, [MarshalAs(UnmanagedType.Interface)] [In]
      ICorProfilerInfo2 callback, [In] uint infoFlags, [In] IntPtr clientData, [In] ref byte context,
      [In] uint contextSize);

    [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)]
    void FunctionEnter2(UIntPtr funcID, UIntPtr clientData, UIntPtr func,
      ref COR_PRF_FUNCTION_ARGUMENT_INFO argumentInfo);

    [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)]
    void FunctionLeave2(UIntPtr funcID, UIntPtr clientData, UIntPtr func,
      ref COR_PRF_FUNCTION_ARGUMENT_RANGE retvalRange);

    [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)]
    void FunctionTailcall2(UIntPtr funcID, UIntPtr clientData, UIntPtr func);

    [MethodImpl(MethodImplOptions.InternalCall)]
    void SetEnterLeaveFunctionHooks2([MarshalAs(UnmanagedType.Interface)] [In]
      ICorProfilerInfo2 pFuncEnter, [MarshalAs(UnmanagedType.Interface)] [In]
      ICorProfilerInfo2 pFuncLeave, [MarshalAs(UnmanagedType.Interface)] [In]
      ICorProfilerInfo2 pFuncTailcall);
