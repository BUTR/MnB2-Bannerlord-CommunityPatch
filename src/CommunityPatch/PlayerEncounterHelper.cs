...
namespace CommunityPatch {
  ...
  public static class PlayerEncounterHelper {
    ...
    public static readonly byte[][] TargetHashes = {
      ...
      new byte[] {
        // e1.5.1.241359
        0x3A, 0xD1, 0xCA, 0xE3, 0xCF, 0xE3, 0xDA, 0x0F,
        0x13, 0x3C, 0x9C, 0xCF, 0x23, 0x65, 0x22, 0x3D,
        0xEB, 0x8A, 0x5B, 0xC9, 0x5D, 0x2D, 0x1A, 0x01,
        0xE5, 0xEA, 0xBB, 0xCD, 0x34, 0xDC, 0x68, 0x18
      }
    };
