...
namespace CommunityPatch {
  ...
  public class LongOptionViewModel : NumericOptionViewModel {

    private sealed class Data : INumericOptionData {

      private readonly Option<long> _option;

      private long _value;

      public Data(Option<long> option) {
        _option = option;
        _value = _option;
      }
      ...
      public float GetMinValue()
        => _option.GetMetadata("Min") is long f ? f : long.MinValue;

      public float GetMaxValue()
        => _option.GetMetadata("Max") is long f ? f : long.MaxValue;
    ...
    public LongOptionViewModel(Option<long> option, OptionsVM optsVm)
