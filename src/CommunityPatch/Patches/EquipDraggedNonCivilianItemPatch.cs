...
namespace CommunityPatch.Patches {
  public static class EquipDraggedNonCivilianItemPatch {
    ...
    internal static readonly byte[][] UpdateCurrentCharacterIfPossibleHashes = {
      ...
      new byte[] {
        // e1.4.3.237794
        0xA1, 0xC2, 0x90, 0x8D, 0x19, 0x11, 0x1C, 0x73,
        0x2C, 0x95, 0x46, 0xDF, 0x6D, 0x3E, 0xE1, 0x39,
        0xAD, 0xDC, 0x00, 0xCC, 0x05, 0x88, 0xDE, 0x76,
        0xEC, 0xCD, 0x1D, 0xFB, 0xE8, 0x8F, 0x5F, 0x58
      }
    };
    ...
    internal static readonly byte[][] InitializeInventoryHashes = {
      ...
      new byte[] {
        // e1.5.1.241359
        0x9F, 0x6E, 0x74, 0x6F, 0x98, 0x02, 0x93, 0x2A,
        0xF6, 0x47, 0x06, 0xBE, 0x38, 0xAC, 0xF7, 0x6B,
        0x09, 0xAB, 0x45, 0x58, 0x36, 0x5B, 0xBD, 0x3A,
        0x96, 0xB6, 0xC1, 0x45, 0xF9, 0x18, 0xDD, 0xD1
      }
    };
