...
namespace CommunityPatch.Patches.Perks.Intelligence.Engineering {
  ...
  public sealed class BuilderPatch2 : PerkPatchBase<BuilderPatch2> {
    ...
    public static readonly byte[][] InternalHashes = {
      ...
      new byte[] {
        // e1.4.3.237794
        0xEA, 0xC4, 0x5A, 0xC7, 0x4E, 0xE0, 0x4B, 0x3E,
        0x05, 0xAC, 0xBB, 0xF5, 0xB0, 0x1D, 0xAC, 0xDA,
        0xB4, 0x66, 0x97, 0x85, 0x49, 0x21, 0x52, 0xF9,
        0xD2, 0xDC, 0x39, 0xF7, 0x38, 0x7E, 0xAE, 0xDB
      }
    };
