...
namespace CommunityPatch.Patches.Perks.Intelligence.Steward {
  ...
  public sealed class LogisticsExpertPatch : PerkPatchBase<LogisticsExpertPatch> {
    ...
    private static readonly MethodInfo TargetMethodInfo = typeof(DefaultPartySpeedCalculatingModel).GetMethod("CalculateFinalSpeed", Public | Instance | DeclaredOnly);

    private static readonly MethodInfo PatchMethodInfo = typeof(LogisticsExpertPatch).GetMethod(nameof(Postfix), NonPublic | Static | DeclaredOnly);
