...
namespace CommunityPatch.Patches.Perks.Intelligence.Steward {
  ...
  public sealed class NourishSettlementPatch : PerkPatchBase<NourishSettlementPatch> {
    ...
    public static readonly byte[][] Hashes = {
      ...
      new byte[] {
        // e1.5.1.241359
        0xA2, 0x14, 0x86, 0x5F, 0x15, 0x1C, 0x1A, 0x4C,
        0xBE, 0xEC, 0x96, 0xAF, 0xA1, 0xD6, 0xB7, 0xB2,
        0xB2, 0x99, 0x6B, 0x4A, 0x11, 0x1F, 0xBE, 0xAB,
        0x6B, 0x11, 0x75, 0x5F, 0xA2, 0x7F, 0xA4, 0x6C
      }
    };
