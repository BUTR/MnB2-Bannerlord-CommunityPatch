...
namespace CommunityPatch.Patches.Perks.Intelligence.Steward {
  ...
  public sealed class ManAtArmsPatch : PerkPatchBase<ManAtArmsPatch> {
    ...
    private static readonly MethodInfo PatchMethodInfo = typeof(ManAtArmsPatch).GetMethod(nameof(Postfix), NonPublic | Static | DeclaredOnly);
    ...
    public static readonly byte[][] Hashes = {
      ...
      new byte[] {
        // e1.4.1.231071
        0xDE, 0x48, 0xEE, 0x41, 0x02, 0xCD, 0x8C, 0x0F,
        0x80, 0x9D, 0x2E, 0xAF, 0x45, 0xD0, 0x8B, 0x37,
        0x66, 0xEB, 0xD5, 0x69, 0x4E, 0x82, 0xCB, 0x39,
        0xAC, 0x19, 0x98, 0x36, 0xEF, 0xFC, 0xD3, 0x6C
      }
    };
