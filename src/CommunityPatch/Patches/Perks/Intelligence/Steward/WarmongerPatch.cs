...
namespace CommunityPatch.Patches.Perks.Intelligence.Steward {
  ...
  public sealed class WarmongerPatch : PerkPatchBase<WarmongerPatch> {
    ...
    public static readonly byte[][] Hashes = {
      ...
      new byte[] {
        // e1.5.1.241359
        0xDC, 0x14, 0x62, 0x8A, 0xAD, 0x1B, 0xAE, 0x8A,
        0x91, 0xCC, 0x2B, 0xBE, 0x5B, 0x69, 0xD1, 0x71,
        0xCA, 0xE0, 0xBA, 0xCB, 0x73, 0x4E, 0xB4, 0x30,
        0x21, 0xCB, 0xB0, 0x89, 0x52, 0x36, 0xCA, 0xE2
      }
    };
