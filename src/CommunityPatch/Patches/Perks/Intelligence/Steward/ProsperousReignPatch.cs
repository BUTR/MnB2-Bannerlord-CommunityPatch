...
namespace CommunityPatch.Patches.Perks.Intelligence.Steward {
  ...
  public sealed class ProsperousReignPatch : PerkPatchBase<ProsperousReignPatch> {
    ...
    public static readonly byte[][] Hashes = {
      ...
      new byte[] {
        // e1.5.1.241359
        0xC5, 0x6F, 0xD5, 0xF5, 0xA2, 0x4A, 0x25, 0x65,
        0x85, 0xC4, 0xC4, 0x51, 0xE0, 0xCA, 0xA9, 0xDB,
        0xBD, 0x3B, 0x07, 0xA7, 0xFF, 0x67, 0x7B, 0xCF,
        0x31, 0x56, 0x1D, 0x16, 0xC0, 0xE1, 0x62, 0xF9
      }
    };
