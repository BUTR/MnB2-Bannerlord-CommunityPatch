...
namespace CommunityPatch.Patches.Perks.Cunning.Scouting {
  ...
  public sealed class HealthyScoutPatch : PerkPatchBase<HealthyScoutPatch> {
    ...
    public static readonly byte[][] Hashes = {
      ...
      new byte[] {
        // e1.5.1.241359
        0xAC, 0x76, 0x4D, 0x77, 0xB1, 0x5B, 0x70, 0x6B,
        0xEE, 0x39, 0xD3, 0xD7, 0x76, 0x64, 0x57, 0xFE,
        0xD7, 0x93, 0x8B, 0x26, 0x13, 0x21, 0x90, 0xC9,
        0xB0, 0x42, 0x5B, 0x53, 0xD1, 0x08, 0x7C, 0xE8
      }
    };
...
#if AFTER_E1_5_1
      PerkHelper.AddPerkBonusForCharacter(perk, character, true, ref explainedNumber);
#else
