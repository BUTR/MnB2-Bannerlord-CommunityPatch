...
namespace CommunityPatch.Patches.Perks.Control.Crossbow {
  ...
  public sealed class MountedCrossbowmanPatch : AgentWeaponEquippedPatch<MountedCrossbowmanPatch> {

    private static readonly MethodInfo PatchMethodInfo = typeof(MountedCrossbowmanPatch).GetMethod(nameof(Prefix), NonPublic | Static | DeclaredOnly);
    ...
    public MountedCrossbowmanPatch() : base("UZHvbYTr") {
    }
