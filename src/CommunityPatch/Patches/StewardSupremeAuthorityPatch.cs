...
namespace CommunityPatch.Patches {
  ...
  internal class StewardSupremeAuthorityPatch : PatchBase<StewardSupremeAuthorityPatch> {
    ...
    private static void Postfix(Clan clan, ref ExplainedNumber influenceChange) {
      ...
      if (ruler != null && ruler == leader && ruler.GetPerkValue(DefaultPerks.Steward.SupremeAuthority)) {
        influenceChange.Add(DefaultPerks.Steward.SupremeAuthority.PrimaryBonus, DefaultPerks.Steward.SupremeAuthority.Name);
      }
    }
  }
