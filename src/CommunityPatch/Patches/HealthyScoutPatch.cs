...
namespace CommunityPatch.Patches {
  ...
  internal class HealthyScoutPatch : PatchBase<HealthyScoutPatch> {
    ...
    private static readonly MethodInfo PatchMethodInfo = typeof(HealthyScoutPatch).GetMethod(nameof(Postfix), BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly);
